...
<body>
    ...
    <h3  class="text-4xl font-bold mb-4">Login Page</h3>
...
<div>
 <button class=" bg-blue-500 mt-5 tracking-wide text-white px-6 py-2 inline-block mb-6 shadow-lg rounded hover:shadow" type="submit">login</button>
</div>
 </form>
 <div>
